            ...
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="{{route('pemilihan.store')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" class="form-control form-control {{$errors->has('waktu_mulai')?'is-invalid':''}}" id="exampleInputPassword4"
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" class="form-control {{$errors->has('waktu_selesai')?'is-invalid':''}}" id="exampleInputPassword4"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{$errors->has('tahun_ajaran')?'is-invalid':''}}" id="exampleInputCity1"
